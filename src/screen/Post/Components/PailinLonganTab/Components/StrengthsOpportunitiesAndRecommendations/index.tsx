...
export const StrengthsOpportunitiesAndRecommendations = ({ dict }: any) => {
  return (
    <div className={`${style.paragraph}`}>
      <h2 className={`leading-9 pb-2 ${style.bold_text}`}>
        {dict?.pailin_longan?.strength_opportunity_and_recommendation?.title}
        <sup>
          {
            dict?.pailin_longan?.strength_opportunity_and_recommendation
              ?.sup_desc_one
          }
        </sup>
      </h2>
          ...
          <TableRow className="bg-[#F2F2F2]">
            <TableCell className="align-top border p-4 text-lg">
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>ការបង្កើនចំណេះដឹង នៃការដាំដុះផ្លៃមៀនប៉ៃលិន</li>
              </ul>
            </TableCell>
            <TableCell className="align-top border p-4 text-lg">
              <ul className="list-disc pl-5 space-y-2">
                <li>មានសក្តានុពលសម្រាប់ការបង្កើនទិន្នផលខ្លាំង</li>
                <li>អាចបង្កើនការផលិត សម្រាប់មៀនប៉ៃលិន</li>
                <li>អាចបង្កើនការកែច្នៃផ្លែមៀនប៉ៃលិន</li>
                <li>បង្កើនការធានាគុណភាព និងសុវត្ថិភាព នៃផ្លែមៀនប៉ៃលិន</li>
                <li>
                  ការដំាដុះដោយមិនប្រើប្រាស់សារធាតុគីមី (Organic production)
                </li>
                <li>
                  កិច្ចព្រមព្រៀងពាណិជ្ជកម្មសេរីរវាងកម្ពុជា និងចិន
                  នឹងជួយជំរុញការនាំចេញផ្លែមៀនប៉ៃលិនទៅកាន់ប្រទេសចិន
                </li>
              </ul>
            </TableCell>
          </TableRow>
      ...
      <ul className="list-disc pl-5 space-y-2 leading-loose">
        ...
        <li>
          ...
          ផលិតកម្មមៀនប៉ៃលិនជាលក្ខណៈពាណិជ្ជកម្ម
        </li>
        <li>
        ...
        <li>រៀបចំធ្វើតេស្ត ពិនិត្យសំណល់ថ្នាំពុលកសិកម្មលើផ្លែមៀនប៉ៃលិន</li>
        <li>
          អភិវឌ្ឍន៍ការអនុវត្តកសិកម្មល្អ និងរៀបចំស្តង់ដារលើលើផលិតកម្មមៀនប៉ៃលិន
        </li>
        <li>លើកកម្ពស់សមាគមមៀនប៉ៃលិន</li>
        <li>ការវេចខ្ចប់តាមបទដ្ឋានអន្តរជាតិ និងតម្រូវការទីផ្សារ</li>
        <li>កសាងហេដ្ឋារចនាសម្ព័ន្ធផ្លូវជនបទ</li>
        <li>
          បង្កើតបណ្តាញខ្សែច្រវាក់តម្លៃ និងបង្កើតរោងចក្រកែច្នៃផ្លែមៀនប៉ៃលិន
        </li>
        <li>កំណត់ទំនិញសម្ភាល់ភូមិសាស្រ្តសម្រាប់មៀនប៉ៃលិន</li>
        <li>
